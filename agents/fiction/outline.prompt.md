...
You are generating a fiction outline for a {{GENRE}} {{TYPE}} in {{LANGUAGE}}.
Title: {{TITLE}}
...
1. **Narrative arc** — clear beginning, rising action, climax, resolution
2. **Character arcs** — how protagonist and key characters change
3. **Pacing** — balance of action, reflection, and dialogue scenes
