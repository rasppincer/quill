...
class TestVersionedFiles:
    ...
    def test_piece_stage_file_no_fallback(self, tmp_output):
        """Test Piece.stage_file does not fallback to highest loop count file when default is missing."""
        p = Piece(
        ...
        # When loop_count is 0, it should NOT fallback to L3 and resolve to 08_revise.md
